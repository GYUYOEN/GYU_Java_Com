	...
	<section class="container">
		...
		<script type="text/javascript">
			...
			function changeModify(element) { // 수정 누르면 삭제 버튼 사라지고 확인버큰이 나옴
				element.innerText = "확인"; // 버튼을 확인으로
				element.nextElementSibling.remove(); // 삭제 버튼 삭제
				
				var content = element.parentElement.previousElementSibling.innerText;
				var textarea = document.createElement("textarea");
				textarea.value = content;
				textarea.setAttribute("class", "form-control");
				element.parentElement.previousElementSibling.innerText = ""; // 기존에 있던 내용을 지움
			...
			function commentDelete(element) { // 서버에 데이터 전송 후 삭제 성공하면 화면 상에서도 삭제

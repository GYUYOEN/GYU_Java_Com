	...
	<section class="container">
		<div class="mt-3">
			...
			<form action="${boardModifyUrl}" method="post">
				...
				<div class="mb-3">
					<input class="form-control" id="id_title" name="title" placeholder="제목을 입력하세요." value="${data.title}"> <!-- value="${param.title}" : 작성한 내용이 오류로 인해 사라지지 않게 하기위한 작업 -->
				</div>
				<div class="mb-3">
					<textarea class="form-control" id="id_content" name="content" 
						rows="5" placeholder="내용을 입력하세요.">${data.content}</textarea> <!-- value="${param.content}" : 작성한 내용이 오류로 인해 사라지지 않게 하기위한 작업 -->
				</div>
				<div class="text-end">
